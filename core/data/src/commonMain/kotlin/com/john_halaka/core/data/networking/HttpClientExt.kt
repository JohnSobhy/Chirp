...
): Result<T, DataError.Remote> {    //each platform throws specific exceptions, okHttp in android and darwin in ios
...
fun constructRoute(route: String): String {
    return when {
        route.contains(UrlConstants.BASE_URL_HTTP) -> route      //this means the whole url is passed already
        route.startsWith("/") -> UrlConstants.BASE_URL_HTTP + route   //this means we passed relative pass starting with /
        else -> UrlConstants.BASE_URL_HTTP + "/" + route          //this means we passed relative pass without /
    }
}